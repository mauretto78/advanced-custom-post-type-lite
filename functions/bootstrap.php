...
{
    try {
        $old_version = get_option('acpt_lite_current_version') ?? get_option('acpt_version', 0);
        $current_version = get_option('acpt_lite_current_version') ? ACPT_LITE_PLUGIN_VERSION : filemtime(__FILE__);
