(self["webpackChunkadvanced_custom_post_type_lite"] = self["webpackChunkadvanced_custom_post_type_lite"] || []).push([[276],{
...
var _assocTaxonomyToPostTypeSlice = __webpack_require__(7833);
...
var AssocTaxonomyToCustomPostTypeElement = function AssocTaxonomyToCustomPostTypeElement(_ref) {
    ...
    var handleOnChange = function handleOnChange(element) {
        dispatch((0, _assocTaxonomyToPostTypeSlice.assocTaxonomyToPostType)({ postType: postType, taxonomies: [element] })).then(function (res) {

            var payload = res.payload;

            if (payload.success) {
                _reactHotToast.toast.success((0, _useTranslation2.default)("Custom post type was associated to selected taxonomies"));
            }
...
exports.default = AssocTaxonomyToCustomPostTypeElement;
...
var _AssocTaxonomyToCustomPostTypeElement = __webpack_require__(4440);

var _AssocTaxonomyToCustomPostTypeElement2 = _interopRequireDefault(_AssocTaxonomyToCustomPostTypeElement);
...
var AssocTaxonomyToCustomPostType = function AssocTaxonomyToCustomPostType() {
    ...
    (0, _react.useEffect)(function () {
        (0, _misc.metaTitle)((0, _useTranslation2.default)((0, _useTranslation2.default)("Associate taxonomies to") + " " + postType));
    ...
    return wp.element.createElement(
        ...
        fetchedPosts.length > 0 && fetchedTaxonomies.records && fetchedTaxonomies.records.length > 0 ? wp.element.createElement(
            "div",
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    "tbody",
                    null,
                    fetchedTaxonomies.records && fetchedTaxonomies.records.map(function (record) {
                        return wp.element.createElement(_AssocTaxonomyToCustomPostTypeElement2.default, {
                            record: record,
                            key: record.id,
                            postType: postType,
                            defaultChecked: !(0, _objects.isEmpty)((0, _objects.filterById)(fetchedPosts[0].taxonomies, record.id))
                        });
                    })
                )
            )
