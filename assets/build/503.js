(self["webpackChunkadvanced_custom_post_type_lite"] = self["webpackChunkadvanced_custom_post_type_lite"] || []).push([[503],{
...
__webpack_require__.d(__webpack_exports__, {
  "yaml": () => (/* binding */ yaml),
  "yamlLanguage": () => (/* binding */ yamlLanguage)
});
...
;// CONCATENATED MODULE: ./node_modules/@lezer/yaml/dist/index.js
...
const indentation = new dist/* ContextTracker */.IK({
  start: Context.top,
  reduce(context, term) {
...
const blockMark = new dist/* ExternalTokenizer */.Jq((input, stack) => {
...
const literals = new dist/* ExternalTokenizer */.Jq((input, stack) => {
  if (input.next == 33 /* '!' */) {
    readTag(input);
...
const blockLiteral = new dist/* ExternalTokenizer */.Jq((input, stack) => {
...
const yamlHighlighting = (0,highlight_dist/* styleTags */.Gv)({
  DirectiveName: highlight_dist/* tags.keyword */.pJ.keyword,
  DirectiveContent: highlight_dist/* tags.attributeValue */.pJ.attributeValue,
  "DirectiveEnd DocEnd": highlight_dist/* tags.meta */.pJ.meta,
  QuotedLiteral: highlight_dist/* tags.string */.pJ.string,
  BlockLiteralHeader: highlight_dist/* tags.special */.pJ.special(highlight_dist/* tags.string */.pJ.string),
  BlockLiteralContent: highlight_dist/* tags.content */.pJ.content,
  Literal: highlight_dist/* tags.content */.pJ.content,
  "Key/Literal Key/QuotedLiteral": highlight_dist/* tags.definition */.pJ.definition(highlight_dist/* tags.propertyName */.pJ.propertyName),
  "Anchor Alias": highlight_dist/* tags.labelName */.pJ.labelName,
  Tag: highlight_dist/* tags.typeName */.pJ.typeName,
...
;// CONCATENATED MODULE: ./node_modules/@codemirror/lang-yaml/dist/index.js
...
*/
const yamlLanguage = /*@__PURE__*/language_dist/* LRLanguage.define */.qp.define({
    name: "yaml",
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/language_dist/* indentNodeProp.add */.uj.add({
                ...
                FlowMapping: /*@__PURE__*/(0,language_dist/* delimitedIndent */.vw)({ closing: "}" }),
                FlowSequence: /*@__PURE__*/(0,language_dist/* delimitedIndent */.vw)({ closing: "]" }),
            }),
            /*@__PURE__*/language_dist/* foldNodeProp.add */.x0.add({
                "FlowMapping FlowSequence": language_dist/* foldInside */.Dv,
...
*/
function yaml() {
    return new language_dist/* LanguageSupport */.ri(yamlLanguage);
}
