...
export const formManagerSlice = createSlice({
    ...
    reducers: {
        ...
        addValidationRule: (state, action) => {
            if(action.payload){
                const {id, isTextual, isMedia} = action.payload;
                ...
                const addValidationRule = (elements, index) => {
                    ...
                    const rule = {
                        id: uuidv4(),
                        condition: isTextual ? "=" : "max_size",
                        value: isTextual ? "123" : "8Mb",
                        message: isTextual ?  "Value is not equal to {{v}}" : "The maximum size is {{v}}"
                    };
        ...
        setPreviewElement:(state, action) => {
            if(action.payload){
