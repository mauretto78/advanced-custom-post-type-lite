...
import {deleteUserMetaBox, updateUserMetaBoxTitle} from "../../../redux/actions/userMetaStateActions";

const UserMetaBoxHeader = ( {id, position, dragHandle, toggleClose}) => {
    ...
    const handleTitleChange = (name) => {
        dispatch(updateUserMetaBoxTitle(id, name));
    };

    // manage local state
    const value = (typeof box !== 'undefined') ? box.name : 'Meta box name';
...
export default UserMetaBoxHeader;