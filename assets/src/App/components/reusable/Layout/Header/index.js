...
const Header = () => {
    ...
    return (
        <header className="acpt-header">
            <div className="logo">
                <svg width="50" height="50" viewBox="0 0 634 572" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="menu">
                <a href="https://acpt.io/checkout/" target="_blank" className="acpt-btn acpt-btn-success buy-pro">
                    Upgrade to PRO
                </a>
                <a
                    href="#"
