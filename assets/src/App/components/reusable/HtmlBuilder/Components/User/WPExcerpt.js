...
export const WPExcerpt = ({fontSize, color, margin, padding, textAlign, css}) => {
    ...
    return (
        <KeyboardInteractiveElement>
            <div
                ...
                dangerouslySetInnerHTML={{__html: postData.post_excerpt !== '' ? postData.post_excerpt :  postData.post_content}}
            />
        </KeyboardInteractiveElement>
    )
};

const WPExcerptSettings = () => {
...
WPExcerpt.craft = {
    displayName: '[wp-excerpt]',
    props: {
        margin: [0,0,20,0, 'px'],
        padding: [0,0,0,0, 'px'],
    },
    related: {
        settings: WPExcerptSettings
    }
};