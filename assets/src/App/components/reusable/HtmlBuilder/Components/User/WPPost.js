...
export const WPPost = ({children, borderRadius, borderThickness, borderColor, background, margin, padding, textAlign, fontWeight, fontStyle, fontSize, css, boxShadow, isDeletable}) => {

    return (
        <KeyboardInteractiveElement>
            <div className="element-container">
                <span className="title">Leading post</span>
