...
const VerticalSortableMetaFields = ({boxIndex, boxId, parentFieldIndex, parentFieldId, parentBlockId, fields, addFieldEnabled = true, view}) => {
    ...
    return (
        <React.Fragment>
            <div
                className={fields && fields.length > 0 && view === 'list' ? "bg-pale-gray b-rounded p-24 flex-column s-24" : ""}
                ref={parent}
            >
