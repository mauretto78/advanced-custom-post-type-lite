    	...
    	return [
		    ...
		    ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_DATASET) => [
		    	'create' => "CREATE TABLE `".ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_DATASET)."` (
					  `id` varchar(36) NOT NULL,
					  `dataset_name` varchar(248) NOT NULL,
		    ...
		    ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_FORM) => [
		    	'create' => "CREATE TABLE `".ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_FORM)."` (
					  `id` varchar(36)   NOT NULL,
					  `form_name` varchar(248) NOT NULL,
					  `label` varchar(255) DEFAULT NULL,
		    ...
		    ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_FORM_SUBMISSION) => [
			    'create' => "CREATE TABLE `".ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_FORM_SUBMISSION)."` (
		            `id` varchar(36) NOT NULL,
					`form_id` varchar(36) NOT NULL,
		    ...
		    ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_PERMISSION) => [
			    'create' => "CREATE TABLE IF NOT EXISTS `".ACPT_Lite_DB::prefixedTableName(ACPT_Lite_DB::TABLE_PERMISSION)."` (
			            id VARCHAR(36) UNIQUE NOT NULL,
